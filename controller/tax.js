    ...
    getIncomeTax:(annualSalary)=>{
        return new Promise(resolve=>{
            if(annualSalary > 0 && annualSalary <= 18200){
                ...
                resolve( Math.round((3572 + 0.325 * (annualSalary - 18200))/12) );
                ...
                resolve( Math.round((3572 + 0.325 * (annualSalary - 87000))/12) );
            }else if(annualSalary >= 180001){
                resolve( Math.round((3572 + 0.325 * (annualSalary - 180000))/12) );
            }
